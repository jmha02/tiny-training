...
# here we use CIFAR10 dataset with mcunet-5fps as an example
# we use optimizer without momentum which saves memory (as in the main results of the paper)

# sparse update (100KB scheme): 88.84%
# python train_cls.py   configs/cifar10.yaml --run_dir runs/cifar10/mcunet-5fps/sparse_100kb/sgd_qas_nomom \
...
# python train_cls.py   configs/cifar10.yaml --run_dir runs/cifar10/mcunet-5fps/full_update/sgd_qas_nomom \
#     --net_name mcunet-5fps  --bs256_lr  0.1  --optimizer_name sgd_scale_nomom \
